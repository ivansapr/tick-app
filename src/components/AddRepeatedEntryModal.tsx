...
const AddRepeatedEntryModal: React.FC<AddRepeatedEntryModalProps> = ({
  tasks,
  projects,
  api,
  onClose,
    ...
    <div style={styles.overlay} onClick={onClose}>
      <div style={styles.modal} onClick={(e) => e.stopPropagation()}>
        <div style={styles.header}>
          <h2 style={styles.title}>Add Repeated Entry</h2>
        ...
        <form onSubmit={handleSubmit} style={styles.form}>
          ...
          <div style={styles.formGroup}>
            <label style={styles.label}>
              Hours per Entry <span style={styles.required}>*</span>
            </label>
            <input
              type="number"
              step="0.25"
...
export default AddRepeatedEntryModal;
